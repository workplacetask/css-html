...
;var F;function G(a,b,c){var d=F;F=null;a||(a=d);d=this.constructor.V;a||(a=d?[d]:[]);this.h=(d?0:-1)-(this.constructor.U||0);this.g=a;a:{d=this.g.length;a=d-1;if(d&&(d=this.g[a],C(d))){this.j=a-this.h;this.i=d;break a}void 0!==b&&-1<b?(this.j=Math.max(b,a+1-this.h),this.i=null):this.j=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)a=c[b],a<this.j?(a+=this.h,(d=this.g[a])?Array.isArray(d)&&B(d):this.g[a]=H):(d=this.j+this.h,this.g[d]||(this.i=this.g[d]={}),(d=this.i[a])?Array.isArray(d)&&B(d):this.i[a]=H)}
